...
| Appointment services / barber & salon flow | Complete as planning doc | Future Roadmap | `ServicesOS/Future-Verticals/appointment-services-barber-salon-flow.md` documents the Booksy/barbershop observation, appointment-based workflow, MVP concepts, and guardrails. | Preserve for later. Do not implement until cleaning beta is stable and Jamie explicitly promotes it. |
